   ...
   //--------Category Interaction Functions: Clicked -------------------------------   
    ...
    var cur_class=d3.select(this).attr("class");
...

      {
        ...
        console.log("category-"+d.item.id);


         bubble.selectAll(".bubbleFill.category-"+d.item.id).style("border-color",color_set(i));
      }
        ...
        .style("border-color","transparent");
          ...
          bubble.selectAll(".category-"+d.item.id).style("border-color","rgb(179,179,179)");
